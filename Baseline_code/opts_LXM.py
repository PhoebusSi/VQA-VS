...
def parse_opt():
    ...
    parser.add_argument('--ans_dim', type=int, default=2486,
                    help='2486 for VQA-VS')
    ...
    parser.add_argument('--batch_size', type=int, default=1024,#512,#256,
                    help='minibatch size')
    ...
    parser.add_argument('--weight_decay', type=float, default=0,
                    help='weight_decay')
    parser.add_argument('--seed', type=int, default=2048,#1024,
                    help='seed')
    parser.add_argument('--ntokens', type=int, default=777,
                    help='ntokens')
    
    parser.add_argument('--dataroot', type=str, default='./data/',help='dataroot')
    parser.add_argument('--img_root', type=str, default='../data/coco/object_features/',help='image_root')
    ...
    parser.add_argument('--output', type=str, default='saved_models/LXMERT/')
